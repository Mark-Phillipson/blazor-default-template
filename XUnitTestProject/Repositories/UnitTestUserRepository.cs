	...
	public class UnitTestUserRepository : IDisposable
	{
		...
		public void DeleteUserRole_TestDeleteOkay()
		{
			...
			using (var context = new AppDbContext(ContextOptions))
			{
				...
				UserRepository sut = new UserRepository(context, mapper);
		...
		public void GetAllUsers_Test()
		{
			...
			using (var context = new AppDbContext(ContextOptions))
			{
				...
				IMapper mapper = new Mapper(config);
				UserRepository userRepository = new UserRepository(context,mapper);
				List<User> result = userRepository.GetAllUsers().ToList();
		...
		public void GetAllUsersInRole_Test()
		{
			...
			using (var context = new AppDbContext(ContextOptions))
			{
				...
				List<User> result = userRepository.GetAllUsersInRole(role.Id).ToList();
